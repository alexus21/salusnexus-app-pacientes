          ...
          <div class="filter-section-content">
            <div class="availability-filter">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="today" id="availabilityToday" v-model="availabilityFilter">
                <label class="form-check-label" for="availabilityToday">
                  <i class="fas fa-calendar-day text-success me-2"></i> Hoy
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="tomorrow" id="availabilityTomorrow" v-model="availabilityFilter">
                <label class="form-check-label" for="availabilityTomorrow">
                  <i class="fas fa-calendar-week text-warning me-2"></i> Mañana
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="week" id="availabilityWeek" v-model="availabilityFilter">
