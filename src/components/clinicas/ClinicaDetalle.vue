              ...
              <div class="row g-3">
                <div class="col-md-12 col-6">
                  <div class="gallery-thumb">
                    <img src="/clinic/clinic_02.jpeg" alt="Imagen de clínica" class="img-fluid rounded">
                  </div>
                </div>
                <div class="col-md-12 col-6">
                  <div class="gallery-thumb position-relative">
                    <img src="/clinic/clinic_03.jpeg" alt="Imagen de clínica" class="img-fluid rounded">
        ...
        <div class="clinic-info card">
          <div class="card-body">
            ...
            <div class="clinic-services">
              <div class="row">
                <div v-for="(service, idx) in clinic.services" :key="idx" class="col-md-6 col-lg-4 mb-3">
