            ...
            <div class="card-body">
                ...
                <div class="setting-item">
                    ...
                    <div class="setting-content">
                        ...
                        <form class="settings-form mt-3" @submit.prevent="changePassword">
                            <div class="input-group-wrapper mb-3">
                                ...
                                <div class="password-input-group">
                                    <input id="currentPassword" v-model="currentPassword"
                                           :type="showPassword.current ? 'text' : 'password'" class="form-control">
                                    <button class="password-toggle" type="button" @click="togglePassword('current')">
                            ...
                            <div class="input-group-wrapper mb-3">
                                ...
                                <div class="password-input-group">
                                    ...
                                    <button class="password-toggle" type="button" @click="togglePassword('new')">
                                        <i :class="showPassword.new ? 'fas fa-eye-slash' : 'fas fa-eye'"></i>
                                    </button>
                                </div>
                                <div v-if="newPassword" class="password-strength mt-2">
                                    <div :class="passwordStrength" class="strength-indicator"></div>
                            ...
                            <div class="input-group-wrapper mb-3">
                                ...
                                <div class="password-input-group">
                                    ...
                                    <button class="password-toggle" type="button" @click="togglePassword('confirm')">
                                        <i :class="showPassword.confirm ? 'fas fa-eye-slash' : 'fas fa-eye'"></i>
                                    </button>
                                </div>
                                <div v-if="newPassword && confirmPassword" class="passwords-match mt-1">
                            ...
                            <button :disabled="isLoading" class="btn btn-primary action-btn" type="submit">
                    ...
                    <div class="setting-content">
                        <div class="setting-header">
                            ...
                            <div class="form-check form-switch large-switch">
                                <input id="twoFactorSwitch" v-model="twoFactorEnabled" class="form-check-input" role="switch"
                                       type="checkbox">
                            </div>
                        </div>
                        <div class="setting-details">
                            <div :class="{'setting-detail-disabled': !twoFactorEnabled}" class="setting-detail-item">
            ...
            <div class="card-body">
                <div class="danger-content">
                    <div>
                        ...
                        <p class="setting-description">Las siguientes acciones son permanentes y no se pueden deshacer.
                            Por favor, procede con precaución.</p>
                    </div>
        ...
        <div v-if="showDeleteModal" class="delete-modal">
            <div class="delete-modal-content">
                <div class="delete-modal-header">
                    ...
                    <button class="btn-close" type="button" @click="showDeleteModal = false"></button>
                </div>
                <div class="delete-modal-body">
                    <p>¿Estás seguro de que deseas eliminar tu cuenta? Esta acción es irreversible y perderás todos tus
                        datos.</p>
                    <div class="delete-confirm-input">
                        <label for="confirmDelete">Escribe "ELIMINAR" para confirmar:</label>
                        <input id="confirmDelete" v-model="deleteConfirmText" class="form-control" placeholder="ELIMINAR"
                               type="text">
                    </div>
                </div>
                <div class="delete-modal-footer">
                    <button class="btn btn-outline-secondary" type="button" @click="showDeleteModal = false">Cancelar
                    </button>
                    <button :disabled="deleteConfirmText !== 'ELIMINAR'" class="btn btn-danger" type="button"
                            @click="deleteAccount">
    ...
    methods: {
        ...
        async changePassword() {
            ...
            try {
                ...
                const response = await fetch(`${API_URL}/update-password/${this.user.user_id}`, {
                    method: 'PUT',
                    headers: {
