<template>
    ...
    <div class="row">
        <div class="row d-flex justify-content-between mt-3 text-start">
            ...
            <div class="col-md-4 billing-cycle" v-if="user.subscription_period">
                ...
                <div class="d-flex align-items-center justify-content-start mt-2">
                    ...
                    <div v-if="user && user.subscription_period">
    ...
    <div class="row light-blue-background mb-5" v-if="user.subscription_period">
        <div class="row">
...
export default {
  ...
  data() {
    const subscriptionPeriod = this.user.subscription_period || '';
    const billingCycle = subscriptionPeriod
        ? subscriptionPeriod.charAt(0).toUpperCase() + subscriptionPeriod.slice(1)
        : 'Sin plan'; // or whatever fallback makes sense

    const currentPlan = this.user.subscription_type === 'paciente_gratis'
        ? 'Recomendado'
        : (this.user.subscription_type ? 'Plan actual' : 'Cargando...');
