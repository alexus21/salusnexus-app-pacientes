        ...
        <div class="row align-items-center">
          <div class="col-lg-7">
            <div class="hero-content" data-aos="fade-right">
              ...
              <p class="hero-description">
                Aquí encontrarás todas las clínicas que has marcado como favoritas para un acceso rápido y conveniente.
              </p>
          ...
          <div class="col-lg-5 d-none d-lg-block">
            <div class="hero-illustration" data-aos="fade-left" data-aos-delay="200">
              <img src="/favorites-illustration.svg" alt="Favoritos" class="floating-img" onerror="this.onerror=null; this.src='https://cdn-icons-png.flaticon.com/512/4403/4403583.png';">
            </div>
          </div>
        </div>
      </div>
            ...
            <div v-for="(favorite, index) in favorites" :key="favorite.id" class="col-lg-4 col-md-6 mb-4">
              <div class="favorite-card" data-aos="fade-up" :data-aos-delay="index * 100">
                <div class="favorite-header">
                  ...
                  <button class="remove-btn" @click="removeFavorite(favorite)" aria-label="Quitar de favoritos">
                ...
                <div class="favorite-body">
                  ...
                  <div class="favorite-actions">
                    <router-link :to="`/clinica/${favorite.clinic_id}`" class="btn btn-primary view-btn">
                      <i class="fas fa-eye me-2"></i> Ver clínica
                    </router-link>
                    <button @click="removeFavorite(favorite)" class="btn btn-outline-danger remove-btn-sm">
...
export default {
  ...
  methods: {
    ...
    async removeFavorite(favorite) {
      try {
        const patient_id = this.userData.patient_profile_id;
